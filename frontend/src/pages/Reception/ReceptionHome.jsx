        ...
        <div className="dashboard-content">
            ...
            <div className="row g-4">
                ...
                <div className="col-lg-6">
                    <div className="card border-0 shadow-sm h-100 rounded-4">
                        <div className="card-header bg-white border-0 pt-4 pb-3">
                            <h5 className="mb-0 fw-bold"><i className="fas fa-id-badge text-success me-2"></i>Thông tin cá nhân</h5>
                        </div>
                        <div className="card-body">
                            <div className="row g-3">
                                <div className="col-12">
                                    <div className="d-flex align-items-center p-3 bg-light rounded">
                                        <i className="fas fa-user-circle fs-3 text-primary me-3"></i>
                                        <div><small className="text-muted d-block">Họ tên</small><strong>{user.username}</strong></div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="d-flex align-items-center p-3 bg-light rounded">
                                        <i className="fas fa-envelope fs-4 text-info me-3"></i>
                                        <div><small className="text-muted d-block">Email</small><strong>reception@medcare.vn</strong></div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="d-flex align-items-center p-3 bg-light rounded">
                                        <i className="fas fa-phone fs-4 text-warning me-3"></i>
                                        <div><small className="text-muted d-block">Điện thoại</small><strong>0912 345 678</strong></div>
                                    </div>
                                </div>
                            </div>
                        </div>
